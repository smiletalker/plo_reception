$(function () {
    ...
    $("#headboD>ul>li").eq(0).mouseover(function () {
        $("#headboMoveD").css({"marginLeft":"15%","width":"30px","opacity":"1"});
    });
    $("#headboD>ul>li").eq(1).mouseover(function () {
        $("#headboMoveD").css({"marginLeft":"28.3%","width":"30px","opacity":"1"});
    });
    $("#headboD>ul>li").eq(2).mouseover(function () {
        $("#headboMoveD").css({"marginLeft":"41.8%","width":"30px","opacity":"1"});
    });
    $("#headboD>ul>li").eq(3).mouseover(function () {
        $("#headboMoveD").css({"marginLeft":"55.2%","width":"57px","opacity":"1"});
    });
    $("#headboD>ul>li").eq(4).mouseover(function () {
        $("#headboMoveD").css({"marginLeft":"72.3%","width":"57px","opacity":"1"});
    });
