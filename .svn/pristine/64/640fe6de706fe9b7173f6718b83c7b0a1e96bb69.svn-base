...
$("#headboD>ul>li").eq(0).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"19%","width":"60px","opacity":"1"});
});
$("#headboD>ul>li").eq(1).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"46%","width":"30px","opacity":"1"});
});
$("#headboD>ul>li").eq(2).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"60%","width":"45px","opacity":"1"});
});
