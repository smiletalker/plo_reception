...
$("#headboD>ul>li").eq(0).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"10%","width":"50px","opacity":"1"});
});
$("#headboD>ul>li").eq(1).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"28%","width":"52px","opacity":"1"});
});
$("#headboD>ul>li").eq(2).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"42.5%","width":"52px","opacity":"1"});
});
$("#headboD>ul>li").eq(3).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"57.2%","width":"52px","opacity":"1"});
});
$("#headboD>ul>li").eq(4).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"71.3%","width":"80px","opacity":"1"});
});
