...
$("#headboD>ul>li").eq(0).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"15%","width":"60px","opacity":"1"});
});
$("#headboD>ul>li").eq(1).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"30.3%","width":"80px","opacity":"1"});
});
$("#headboD>ul>li").eq(2).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"45.8%","width":"60px","opacity":"1"});
});
$("#headboD>ul>li").eq(3).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"57.2%","width":"83px","opacity":"1"});
});
$("#headboD>ul>li").eq(4).mouseover(function () {
    $("#headboMoveD").css({"marginLeft":"73%","width":"60px","opacity":"1"});
});
